...
/**
 * Analyse les produits du groupe 4 qui ont 'beef' dans nova_groups_markers
 * Permet de comprendre pourquoi beef est classé comme marqueur du groupe 4
 */
public class AnalyzeBeefInGroup4 {
    ...
    private static class ProductWithBeef {
        String code;
        String productName;
        int novaGroup;
        List<String> beefMarkerTypes;  // Types où beef apparaît (categories, ingredients, additives)
        List<String> allGroup4Markers;  // Tous les marqueurs du groupe 4
        
        ProductWithBeef(String code, String productName, int novaGroup) {
            this.code = code;
            this.productName = productName;
            this.novaGroup = novaGroup;
            this.beefMarkerTypes = new ArrayList<>();
            this.allGroup4Markers = new ArrayList<>();
        }
    }
    
    private static List<ProductWithBeef> productsWithBeef = new ArrayList<>();

    public static void main(String[] args) {
        new NatclinnConf();
        try {
            System.out.println("=== Analyse des produits groupe 4 avec 'beef' dans nova_groups_markers ===\n");
            ...
            System.out.println("\n=== Produits trouvés avec beef en groupe 4: " + productsWithBeef.size() + " ===\n");
            
            // Générer le fichier Excel
            String outputPath = NatclinnConf.folderForData + "/Beef_in_Group4_Analysis.xlsx";
    ...
    /**
     * Télécharge et analyse le fichier JSONL pour trouver les produits groupe 4 avec beef
     */
    private static void analyzeBeefInGroup4() throws Exception {
        ...
        try (InputStream in = conn.getInputStream();
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    // Chercher les produits groupe 4 avec beef
                    if (product.has("nova_group") && product.getInt("nova_group") == 4 && 
                        ...
                        if (markersObj.has("4")) {
                            ...
                            // Chercher beef dans ce groupe
                            boolean hasBeef = false;
                            List<String> beefTypes = new ArrayList<>();
                            ...
                            if (hasBeef) {
                                ...
                                ProductWithBeef p = new ProductWithBeef(code, productName, 4);
                                p.beefMarkerTypes = beefTypes;
                                p.allGroup4Markers = allMarkersInGroup4;
                                productsWithBeef.add(p);
                            }
                        }
                    }
        ...
        System.out.println(String.format("  Produits groupe 4 avec beef: %,d", matchingProducts));
    }
    
    private static void generateExcelFile(String outputPath) throws Exception {
        Workbook workbook = new XSSFWorkbook();
        Sheet sheet = workbook.createSheet("Beef in Group 4");
        ...
        String[] headers = {"Code OFF", "Nom Produit", "Beef Types", "Tous les marqueurs groupe 4"};
        ...
        // Données
        int rowNum = 1;
        for (ProductWithBeef p : productsWithBeef) {
            ...
            cell2.setCellValue(String.join(", ", p.beefMarkerTypes));
    ...
    private static void displaySummary() {
        ...
        for (ProductWithBeef p : productsWithBeef) {
            if (count++ < 10) {
                ...
                System.out.println("  Beef types: " + String.join(", ", p.beefMarkerTypes));
        ...
        if (productsWithBeef.size() > 10) {
            System.out.println("\n... et " + (productsWithBeef.size() - 10) + " autres produits");
        }
        System.out.println("...");
    }
}
