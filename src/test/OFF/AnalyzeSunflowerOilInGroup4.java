...
/**
 * Analyse les produits du groupe 4 qui ont 'sunfloweroil' dans nova_groups_markers
 * Permet de comprendre pourquoi sunfloweroil est classé comme marqueur du groupe 4
 */
public class AnalyzeSunflowerOilInGroup4 {
    ...
    private static class ProductWithSunflowerOil {
        String code;
        String productName;
        int novaGroup;
        List<String> sunfloweroilMarkerTypes;  // Types où sunfloweroil apparaît (categories, ingredients, additives)
        List<String> allGroup4Markers;  // Tous les marqueurs du groupe 4
        
        ProductWithSunflowerOil(String code, String productName, int novaGroup) {
            this.code = code;
            this.productName = productName;
            this.novaGroup = novaGroup;
            this.sunfloweroilMarkerTypes = new ArrayList<>();
            this.allGroup4Markers = new ArrayList<>();
        }
    }
    
    private static List<ProductWithSunflowerOil> productsWithSunflowerOil = new ArrayList<>();

    public static void main(String[] args) {
        new NatclinnConf();
        try {
            System.out.println("=== Analyse des produits groupe 4 avec 'sunfloweroil' dans nova_groups_markers ===\n");
            ...
            analyzeSunflowerOilInGroup4();
            
            System.out.println("\n=== Produits trouvés avec sunfloweroil en groupe 4: " + productsWithSunflowerOil.size() + " ===\n");
            
            // Générer le fichier Excel
            String outputPath = NatclinnConf.folderForData + "/SunflowerOil_in_Group4_Analysis.xlsx";
    ...
    /**
     * Télécharge et analyse le fichier JSONL pour trouver les produits groupe 4 avec sunfloweroil
     */
    private static void analyzeSunflowerOilInGroup4() throws Exception {
        ...
        try (InputStream in = conn.getInputStream();
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    // Chercher les produits groupe 4 avec sunfloweroil
                    if (product.has("nova_group") && product.getInt("nova_group") == 4 && 
                        ...
                        if (markersObj.has("4")) {
                            ...
                            // Chercher sunfloweroil dans ce groupe
                            boolean hasSunflowerOil = false;
                            List<String> sunfloweroilTypes = new ArrayList<>();
                            ...
                            for (int i = 0; i < group4Markers.length(); i++) {
                                try {
                                    ...
                                    if (markerPair.length() >= 2) {
                                        ...
                                        if ("en:sunflower-oil".equals(value)) {
                                            hasSunflowerOil = true;
                                            sunfloweroilTypes.add(type);
                                        }
                                    }
                                } catch (Exception e) {
                            ...
                            if (hasSunflowerOil) {
                                ...
                                ProductWithSunflowerOil p = new ProductWithSunflowerOil(code, productName, 4);
                                p.sunfloweroilMarkerTypes = sunfloweroilTypes;
                                p.allGroup4Markers = allMarkersInGroup4;
                                productsWithSunflowerOil.add(p);
                            }
                        }
                    }
        ...
        System.out.println(String.format("  Produits groupe 4 avec sunfloweroil: %,d", matchingProducts));
    }
    
    private static void generateExcelFile(String outputPath) throws Exception {
        Workbook workbook = new XSSFWorkbook();
        Sheet sheet = workbook.createSheet("SunflowerOil in Group 4");
        ...
        String[] headers = {"Code OFF", "Nom Produit", "SunflowerOil Types", "Tous les marqueurs groupe 4"};
        ...
        // Données
        int rowNum = 1;
        for (ProductWithSunflowerOil p : productsWithSunflowerOil) {
            ...
            cell2.setCellValue(String.join(", ", p.sunfloweroilMarkerTypes));
    ...
    private static void displaySummary() {
        ...
        for (ProductWithSunflowerOil p : productsWithSunflowerOil) {
            if (count++ < 10) {
                ...
                System.out.println("  SunflowerOil types: " + String.join(", ", p.sunfloweroilMarkerTypes));
        ...
        if (productsWithSunflowerOil.size() > 10) {
            System.out.println("\n... et " + (productsWithSunflowerOil.size() - 10) + " autres produits");
        }
        System.out.println("...");
    }
}
