...
/**
 * Analyse les produits du groupe 4 qui ont 'cereal' dans nova_groups_markers
 * Permet de comprendre pourquoi cereal est classé comme marqueur du groupe 4
 */
public class AnalyzeCerealInGroup4 {
    ...
    public static void main(String[] args) {
        new NatclinnConf();
        try {
            System.out.println("=== Analyse des produits groupe 4 avec 'cereal' dans nova_groups_markers ===\n");
            ...
            analyzeCerealInGroup4();
            
            System.out.println("\n=== Produits trouvés avec cereal en groupe 4: " + productsWithCereal.size() + " ===\n");
            
            // Générer le fichier Excel
            String outputPath = NatclinnConf.folderForData + "/Cereal_in_Group4_Analysis.xlsx";
    ...
    /**
     * Télécharge et analyse le fichier JSONL pour trouver les produits groupe 4 avec cereal
     */
    private static void analyzeCerealInGroup4() throws Exception {
        ...
        try (InputStream in = conn.getInputStream();
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    // Chercher les produits groupe 4 avec cereal
                    if (product.has("nova_group") && product.getInt("nova_group") == 4 && 
                        ...
                        if (markersObj.has("4")) {
                            ...
                            if (hasCereal) {
                                ...
                                ProductWithCereal p = new ProductWithCereal(code, productName, 4);
        ...
        System.out.println(String.format("  Produits groupe 4 avec cereal: %,d", matchingProducts));
    }
    
    private static void generateExcelFile(String outputPath) throws Exception {
        Workbook workbook = new XSSFWorkbook();
        Sheet sheet = workbook.createSheet("Cereal in Group 4");
        ...
        String[] headers = {"Code OFF", "Nom Produit", "Cereal Types", "Tous les marqueurs groupe 4"};
