...
/**
 * Analyse les produits du groupe 4 qui ont 'milk' dans nova_groups_markers
 * Permet de comprendre pourquoi milk est classé comme marqueur du groupe 4
 */
public class AnalyzeMilkInGroup4 {
    ...
    private static class ProductWithMilk {
        String code;
        String productName;
        int novaGroup;
        List<String> milkMarkerTypes;  // Types où milk apparaît (categories, ingredients, additives)
        List<String> allGroup4Markers;  // Tous les marqueurs du groupe 4
        
        ProductWithMilk(String code, String productName, int novaGroup) {
            this.code = code;
            this.productName = productName;
            this.novaGroup = novaGroup;
            this.milkMarkerTypes = new ArrayList<>();
            this.allGroup4Markers = new ArrayList<>();
        }
    }
    
    private static List<ProductWithMilk> productsWithMilk = new ArrayList<>();

    public static void main(String[] args) {
        new NatclinnConf();
        try {
            System.out.println("=== Analyse des produits groupe 4 avec 'milk' dans nova_groups_markers ===\n");
            ...
            System.out.println("\n=== Produits trouvés avec milk en groupe 4: " + productsWithMilk.size() + " ===\n");
            
            // Générer le fichier Excel
            String outputPath = NatclinnConf.folderForData + "/Milk_in_Group4_Analysis.xlsx";
    ...
    /**
     * Télécharge et analyse le fichier JSONL pour trouver les produits groupe 4 avec milk
     */
    private static void analyzeMilkInGroup4() throws Exception {
        ...
        try (InputStream in = conn.getInputStream();
            ...
            while ((line = reader.readLine()) != null) {
                ...
                try {
                    ...
                    // Chercher les produits groupe 4 avec milk
                    if (product.has("nova_group") && product.getInt("nova_group") == 4 && 
                        ...
                        if (markersObj.has("4")) {
                            ...
                            if (hasMilk) {
                                ...
                                ProductWithMilk p = new ProductWithMilk(code, productName, 4);
                                p.milkMarkerTypes = milkTypes;
                                p.allGroup4Markers = allMarkersInGroup4;
                                productsWithMilk.add(p);
                            }
                        }
                    }
        ...
        System.out.println(String.format("  Produits groupe 4 avec milk: %,d", matchingProducts));
    }
    
    private static void generateExcelFile(String outputPath) throws Exception {
        Workbook workbook = new XSSFWorkbook();
        Sheet sheet = workbook.createSheet("Milk in Group 4");
        ...
        String[] headers = {"Code OFF", "Nom Produit", "Milk Types", "Tous les marqueurs groupe 4"};
        ...
        // Données
        int rowNum = 1;
        for (ProductWithMilk p : productsWithMilk) {
            ...
            cell2.setCellValue(String.join(", ", p.milkMarkerTypes));
    ...
    private static void displaySummary() {
        ...
        for (ProductWithMilk p : productsWithMilk) {
            if (count++ < 10) {
                ...
                System.out.println("  Milk types: " + String.join(", ", p.milkMarkerTypes));
        ...
        if (productsWithMilk.size() > 10) {
            System.out.println("\n... et " + (productsWithMilk.size() - 10) + " autres produits");
        }
        System.out.println("...");
    }
}
